...
* [FIWARE Data Space Connector](https://github.com/FIWARE/data-space-connector) — Brings together a set of open-source software components, some of them developed within the FIWARE Community, to allow organizations participation in a Data Space in various roles (Provider, Consumer, Marketplace).
